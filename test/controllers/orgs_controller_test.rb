...
class OrgsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create org" do
    assert_difference('Org.count') do
      post orgs_url, params: { org: { name: @org.name, location: @org.location, description: @org.description, website: @org.website} }
    end
  ...
  test "should update org" do
    patch org_url(@org), params: { org: { name: @org.name, location: @org.location, description: @org.description, website: @org.website} }
