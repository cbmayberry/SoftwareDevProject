class OrgsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @org.save
        format.html { redirect_to @org, notice: "Organization was successfully added." }
  ...
  def destroy
    @org.destroy
    respond_to do |format|
      format.html { redirect_to orgs_url, notice: "Organization has been removed." }
  ...
  private
    ...
    def org_params
      params.require(:org).permit(:name, :location, :description)
    end
end
